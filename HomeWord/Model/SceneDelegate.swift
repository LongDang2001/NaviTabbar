...
class SceneDelegate: UIResponder, UIWindowSceneDelegate, UITabBarControllerDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        //Messages
        let messagesVC = MesengerViewController()
        ...
        messagesVC.tabBarItem.badgeValue = "99"
        ...
        profileVC.tabBarItem = UITabBarItem(title: "image Test", image: UIImage(named: "wafflewolfaa"), tag: 3)
        profileVC.navigationController?.navigationBar.barTintColor = UIColor.yellow
        
        let tabbarController = UITabBarController()
        tabbarController.viewControllers = [homeVC, messagesVC,friendsVC, profileVC]
        //tabbarController.tabBar.backgroundColor = UIColor.cyan
        tabbarController.tabBar.barTintColor = UIColor.cyan
        tabbarController.tabBar.tintColor = UIColor.red
        
        //tabbarController.tabBarItem.title = "aaa"
        
//        tabbarController.tabBar.items = [
//            UITabBarItem(tabBarSystemItem: .bookmarks, tag: 0),
//            UITabBarItem(tabBarSystemItem: .favorites, tag: 1),
//            UITabBarItem(tabBarSystemItem: .history, tag: 2),
//            UITabBarItem(tabBarSystemItem: .featured, tag: 3),
//        ]
